...
Con este ejercicio queda clara la importancia de los detalles y el vocabulario empleado a la hora de comunicar una idea o proceso. Cuando mis papás comenzaron a seguir los pasos, me di cuenta que les pareció confuso interpretar la posición en la que quería que colocaran las cartas, por lo que asumo que un lenguaje menos técnico podría haberles funcionado mejor.\\\\
Asimismo, es fundamental destacar la importancia de los detalles que se proporcionan en este contexto, puesto que siempre se deben dejar claros los contenidos desde todos los ángulos, incluso cuando se considera algo como obvio. Sin embargo, es fundamental filtrar la información antes de compartirla, ya que un exceso de detalles puede generar confusión en vez de evitarla.
